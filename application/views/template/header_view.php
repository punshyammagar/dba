...
<head>
    ...
    <title> Diabetes Control Australia</title>
    ...
    <!-- Custom tab icons -->
    <link rel="shortcut icon" href="<?=base_url()?>assets/images/dba-icon.png" type="image/x-icon">
    <link href="<?=base_url()?>assets/js/jquery-ui-1.12.1.custom/jquery-ui.css" rel="stylesheet" type="text/css" />
    <link href="<?=base_url()?>assets/js/jquery-ui-1.12.1.custom/jquery-ui-custom-datepicker.css" rel="stylesheet" type="text/css" />
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url();?>">
                    <div class="inline"> &nbsp;Diabetes Control Australia </div>
                </a>
            ...
            <div class=" navbar-brand navbar-right navbar-access-level"> 
                User Group: <?=ucfirst($this->session->userdata('role'));?>
                &nbsp;
            </div>
            <!-- /.navbar-top-links -->
